CREATE TABLE [dbo].[Fabric_Plan_Amend]
(
	[FPlanAmndId] INT NOT NULL PRIMARY KEY IDENTITY(1,1),
	[FPlanId] [int]  NULL,
	[CompSlNo] [int] NULL,
	[PlanID] [int] NULL,
    ...
    CONSTRAINT [FK_Fabric_Plan_am_Color] FOREIGN KEY ([ColorID]) REFERENCES [Color]([Colorid]),
	CONSTRAINT [FK_Fabric_Plan_am_BColor] FOREIGN KEY ([BaseColorID]) REFERENCES [Color]([Colorid]),
	CONSTRAINT [FK_Fabric_Plan_am_FColor] FOREIGN KEY ([FinishColorID]) REFERENCES [Color]([Colorid]),
	CONSTRAINT [FK_Fabric_Plan_am_PColor] FOREIGN KEY ([PrintColorId]) REFERENCES [Color]([Colorid]),
	CONSTRAINT [FK_Fabric_Plan_am_Item] FOREIGN KEY ([FabricId]) REFERENCES [Item]([Itemid]),
	CONSTRAINT [FK_Fabric_Plan_am_Size] FOREIGN KEY ([SizeId]) REFERENCES [Size]([Sizeid]),
	--CONSTRAINT [FK_Fabric_Plan_Planning_Mas] FOREIGN KEY ([PlanID]) REFERENCES [Planning_Mas]([PlanID]), 
    CONSTRAINT [CK_Fabric_Plan_am_Fabric_type] CHECK (([fabric_type] = 'K' or [fabric_type] = 'W' or [fabric_type] = 'P'))
)
