...
function getDate() {
    ...
    $('#textFromDate').val(MainFDate);
    $('#textToDate').val(Fdatestring);
}
...
function LoadReport() {
    ...
    window.open("../Reports/Planning/BudgetApprovalStatusReport.aspx?fdate=" + fromDate + "&tdate=" + todate + "&compid=" + CompId + "&buyid=" + BuyId + "&jobno=" + JobOrdNo + "&styleid=" + StyId + "&ordno=" + OrdNo + "&refno=" + Mref + "&status=" + Status)
}