...
function LoadReport() {
    ...
    window.open("../Reports/Process/ProcessOrder/ProcessOrderReport.aspx?Masid=" + bid +  "&FromDate=" + frmdate + "&ToDate=" + todate
         + "&Ordtype=" + protype + "&Ref=" + ref + "&Color=" + clr + "&Size=" + size + "&yarnid=" + ynid + "&Fabid=" + fabid + "&Procid=" + procid + "&CompName=" + compname + "&ProName=" + ProName + "&supid=" + supp + "&UserName=" + UserName);
