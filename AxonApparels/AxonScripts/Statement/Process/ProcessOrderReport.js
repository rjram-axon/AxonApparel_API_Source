...
function LoadReport() {
    ...
    window.open("../Reports/Process/ProcessOrder/ProcessOrderStatementReport.aspx?Compid=" + CmpID + "&Masid=" + bid
        + "&Buyid=" + buyer + "&fdate=" + frmdate + "&tdate=" + todate
             + "&Ordtype=" + protype + "&Ref=" + ref + "&Color=" + clr + "&Size=" + size + "&Jobid=" + jobno + "&Itmid=" + itmid + "&unitid=" + unit + "&suppid=" + suppid + "&processid=" + processid + "&Userid=" + LoginUserid);
