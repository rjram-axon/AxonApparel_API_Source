...
function LoadReport() {
    ...
    window.open("../Reports/Stores/StockInwardReport.aspx?CompId=" + CmpID + "&BuyerID=" + BuyID + "&RefNo=" + RefNo + "&OrderNo=" + OrdNo + "&StyleID=" + StyleID + "&ItemId=" + ItemID + "&FromDate=" + FDate + "&ToDate=" + TDate + "&SupplierId=" + SupplierId + "&OType=" + OType);
}
