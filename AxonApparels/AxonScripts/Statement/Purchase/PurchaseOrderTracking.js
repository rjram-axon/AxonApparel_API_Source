...
function LoadReport() {
    ...
    window.open("../Reports/Stores/PurchaseOrderTracking.aspx?CompanyID=" + CmpID + "&OrderNo=" + OrdNo + "&RefNo=" + RefNo + "&StyID=" + StyID + "&SuppID=" + SuppID + "&PoNo=" + PoNo + "&FromDate=" + FDate + "&ToDate=" + TDate + "&OType=" + OType + "&POType=" + POType + "&LType=" + LType + "&Recno=" + RecNo + "&Deli=" + DeliID + "&itemid=" + ItemID + "&colorid=" + Colorid + "&sizeid=" + Sizeid + "&process=" + Process);
