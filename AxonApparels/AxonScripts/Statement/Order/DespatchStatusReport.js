...
function LoadReport() {
    ...
    window.open("../Reports/Order/DespatchStatusReport.aspx?CompanyID=" + CmpID + "&BuyerID=" + BuyID + "&Refno=" + Refno + "&OrderNo=" + OrdNo + "&StyleID=" + StyID + "&SeasonID=" + SeasonID + "&FromDate=" + FDate + "&ToDate=" + TDate + "&ManagerID=" + ManagerID + "&MerchandiserID=" + MerchandiserID + "&statustype=" + statustype + "&ordertype=" + ordertype + "&proctype=" + DtType + "&ViweColor=" + ViweColor + "&CompUnitID=" + cmpunitID + "&ColorID=" + ColorId + "&groupby=" + groupby + "&Sewing=" + chkActProd);
