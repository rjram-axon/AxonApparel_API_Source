...
function LoadReport() {
    ...
    var Sizechecked = $('#ChkSize').is(":checked");
    ...
    window.open("../Reports/Production/DailyCuttingReport/DailyCuttingReport.aspx?OrderNo=" + OrdNo + "&StyleID=" + StyID + "&BuyerID=" + BuyID + "&CompId=" + CmpID + "&FromDate=" + FDate + "&ToDate=" + TDate + "&RefNo=" + RfNo + "&Size=" + Sizechecked);

    //window.open("../Reports/Production/DailyCuttingReport/DailyCuttingReport.aspx");
}
function getDate() {
