...
function LoadReport() {
   ...
   /// window.open("../Reports/Production/CuttingReceiptStatementReport.aspx");


    window.open("../Reports/Production/CuttingReceiptStatementReport.aspx?CompanyID=" + CmpID + "&UnitId=" + UnitID + "&BuyerID=" + BuyID + "&OrdNo=" + OrdNo + "&RefNo=" + RefNo + "&StyleID=" + StyleID + "&ProcessorId=" + ProcessorID + "&StoreId=" + StoreID
