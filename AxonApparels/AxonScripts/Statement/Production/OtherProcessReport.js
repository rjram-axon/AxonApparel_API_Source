...
function LoadReport() {
    ...
    window.open("../Reports/Production/OtherProcessReport.aspx?CompId=" + CmpID + "&BuyerID=" + BuyID + "&RefNo=" + RefNo + "&OrderNo=" + OrdNo + "&StyleID=" + StyleID + "&ItemId=" + ItemID + "&FromDate=" + FDate + "&ToDate=" + TDate + "&process_workdiv_id=" + process_workdiv_id + "&processId=" + ProcessID + "&Processortype=" + inorext);

    //window.open("../Reports/Production/CommonProdReceiptStatementReport.aspx?CompanyID=" + CmpID + "&UnitId=" + UnitID + "&BuyerID=" + BuyID + "&OrdNo=" + OrdNo + "&RefNo=" + RefNo + "&StyleID=" + StyleID + "&ProcessorId=" + ProcessorID + "&StoreId=" + StoreID
