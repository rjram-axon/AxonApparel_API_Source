...
function LoadReport() {
   ...
   /// var SizeID = $('#ddlMSize').val();
    ...
    window.location.href = "../Reports/Production/SewingReturnStatementReport.aspx";

    //window.open("../Reports/Production/SewingReturnStatementReport.aspx?CompanyID=" + CmpID + "&UnitId=" + UnitID + "&BuyerID=" + BuyID + "&OrdNo=" + OrdNo + "&RefNo=" + RefNo + "&StyleID=" + StyleID + "&ProcessorId=" + ProcessorID 
