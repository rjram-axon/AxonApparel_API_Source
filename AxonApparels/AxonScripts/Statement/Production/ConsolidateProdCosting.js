...
function LoadReport() {
    ...
    window.open("../Reports/Production/ConsolidateProductionCosting/ConsolidateProductionCostingReport.aspx?OrderNo=" + OrdNo + "&StyleID=" + StyID + "&BuyerID=" + BuyID + "&CompId=" + CmpID + "&FromDate=" + FDate + "&ToDate=" + TDate + "&RefNo=" + RfNo + "&ColorGrp=" + Colorchecked + "&SizeGrp=" + Sizechecked + "&DtFilter=" + datefil);
}
function getDate() {
