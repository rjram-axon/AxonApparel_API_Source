...
function LoadReport() {
   ...
   // var SizeID = $('#ddlMSize').val();
    ...
    window.location.href = "../Reports/Production/CommonProdReturnStatementReport.aspx";

    //window.open("../Reports/Production/CuttingOrderStatementReport.aspx?CompanyID=" + CmpID + "&UnitId=" + UnitID + "&BuyerID=" + BuyID + "&OrdNo=" + OrdNo + "&RefNo=" + RefNo + "&StyleID=" + StyleID + "&ProcessorId=" + ProcessorID 
