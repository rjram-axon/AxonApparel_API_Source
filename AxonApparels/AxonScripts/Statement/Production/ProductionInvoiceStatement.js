...
function LoadReport() {
    ...
    window.open("../Reports/Production/ProductionInvoiceReportStatement/ProductionInvoiceStatement.aspx?fdate=" + FDate + "&tdate=" + TDate + "&ByOrdId=" + bid + "&RefId=" + ref + "&BuyId=" + BuyID + "&PrcId=" + ProcID + "&ItmId=" + ItmID + "&ColId=" + ColID + "&CompId=" + CompID + "&Otype=" + protype + "&UnId=" + unId + "&Supid=" + Supplierid);
