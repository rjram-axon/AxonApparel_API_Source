...
function LoadReport() {
    ...
    window.open("../Reports/Stores/GreyPurchaseOrdRpt.aspx?Masid=" + bid + "&Fabid=" + fabid + "&FromDate=" + frmdate + "&ToDate=" + todate
    + "&Ordtype=" + protype + "&Ref=" + ref + "&Color=" + clr+"&Size="+size+"&Supplier="+supp);
}