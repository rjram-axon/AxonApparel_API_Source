...
function LoadReport() {
    ...
    window.open("../Reports/StyleWisePoDetReport.aspx?OrderNo=" + OrdNo + "&StyleID=" + StyID + "&RefNo=" + RefNo + "&CompId=" + CmpID + "&SuppId=" + SuppID + "&ItemType=" + ItmType + "&FromDate=" + FDate + "&ToDate=" + TDate)
