...
$(document).ready(function () {
    ...
    var fill = localStorage.getItem('SpecialReqFilter');
...
function LoadAdd() {
    ...
    if (cmpyid == 0) {
        ...
        var Mode = 0;
        window.location.href = "/SpecialRequisitionAdd/SpecialRequisitionAddIndex?CompnyId=" + cmpyid + "=&Mode=" + Mode;
    }
}
...
function LoadMaingrid() {
    ...
    localStorage.setItem('SpecialReqFilter', menufilter);


    $.ajax({
        url: "/SpecialRequisitionMain/GetkMainDetails",
...
function getbyID(masid) {
    debugger;
    var Mode = 1;
    window.location.href = "/SpecialRequisitionAdd/SpecialRequisitionAddIndex?MasId=" + masid + "=&Mode=" + Mode;
}
