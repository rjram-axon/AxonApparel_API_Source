...
$(document).ready(function () {
    ...
    var fill = localStorage.getItem('PurchaseOrderYarnMainFilter');
...
function LoadMainGrid() {
    ...
    localStorage.setItem('PurchaseOrderYarnMainFilter', menufilter);
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            if (ChkSupplier) {
                ...
                $('#ddlMSupplier').append($('<option/>').val('0').text('--Select Supplier--'));
                $.each(rev, function () {
                    $('#ddlMSupplier').append($('<option></option>').val(this.buyerid).text(this.Supp));
                });
        ...
        if (RptTyp == "M") {
            ...
            $.ajax({
                ...
                url: "../ReportInline/Purchase/PurchaseOrderTrimsInlineReport/PurchaseOrderTrimsInlineReport.aspx?PurOrdId=" + PurOrdId
                 ...
                 + p[18] + "&Mdcpy=" + p[19] + "&RptOpt=" + Rpt + "&RptTyp=" + 'P' + "&LoginUnit=" + LoginUnit,
                data: "",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
