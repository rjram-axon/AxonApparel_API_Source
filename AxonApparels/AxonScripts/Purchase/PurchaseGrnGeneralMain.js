...
function LoadGrnOrderAdd() {
    ...
    var OrderType = "G";
    var PurType = $("input[name='MIType']:checked").val();
    var IType = "L";
    //if (OrderType == "B") {
    var OTy = "B";
    window.location.href = "/GRNAdd/GRNAddIndex?PGMasId=" + PGMID + "=&OrderType=" + OrderType + "=&PType=" + PurType;
    // }
...
function getbyID(Id, CpmId, SupId) {
    debugger;
...
function Delete(Id, CpmId, SupId) {
    debugger;
