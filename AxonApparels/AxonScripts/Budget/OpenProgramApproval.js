...
$(document).ready(function () {
    ...
    //$('#ddlproType').val(1);
    load();
    var fill = localStorage.getItem('OpenProgramApprovalFilter');
    ...
    $(document).on('click', '.btnprodplanedit', function () {
        ...
        GEditApptype = currentval[0]['Approved'];
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.Value == 1) {
                ...
                var flg = 1;
                var mod = 0;
                var url = "/ProcessProgram/ProcessProgramIndex";
                AlartMessage(msg, flg, mod, url);
            }
            else {
...
function loadData(Gp) {
    ...
    var menufilter = FDate + ',' + TDate + ',' + cmpid + ',' + buyerid + ',' + ordNo + ',' + unitid + ',' + RecNo + ',' + 'G' + ',' + type + ',' + AppprgType + ',' + AppType;
    localStorage.setItem('OpenProgramApprovalFilter', menufilter);

    $.ajax({
        type: "POST",
        url: '/ProcessProgram/List',
        data: JSON.stringify({ FromDate: FDate, ToDate: TDate, CompanyId: cmpid, buyerid: buyerid, orderno: ordNo, cmpnyunitid: unitid, refno: RecNo, prgmtype: 'G', Ordertype: type, AppprgType: AppprgType, AppType: AppType }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (json) {
            debugger;
...
function loadDataFromBack(Gp) {
    ...
    $.ajax({
        type: "POST",
        url: '/ProcessProgram/List',
        data: JSON.stringify({ FromDate: fillobj[0], ToDate: fillobj[1], CompanyId: fillobj[2], buyerid: fillobj[3], orderno: fillobj[4], cmpnyunitid: fillobj[5], refno: fillobj[6], prgmtype: 'G', Ordertype: fillobj[8], AppprgType: fillobj[9], AppType: fillobj[10] }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (json) {
            debugger;
...
function load() {
    ...
    $.ajax({
        ...
        data: JSON.stringify({ FromDate: FDate, ToDate: TDate, CompanyId: cmpid, buyerid: buyerid, orderno: ordNo, cmpnyunitid: unitid, refno: RecNo, prgmtype: 'G', Ordertype: type }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (json) {
            debugger;
...
function getprodlist(id) {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            var date = prodedit[0].ProProgDate;
...
function getbyidOpen(id) {
    ...
    $.ajax({
        type: "POST",
        url: '/ProcessProgram/GetProdPlanningEditAppOpen/',
        data: JSON.stringify({ Id: id, MaxId: GMaxChk, GAppType: GAppType }),
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (json) {
            debugger;
...
function SubReport() {
    ...
    window.open("../ReportInline/Planning/ProcessProg/ProcessProgInline.aspx?JobId=" + GJobId + "&Companyid=" + compid);
}
