...
$(document).ready(function () {
    ...
    var fill = localStorage.getItem('ProcessOrderApprovalFilter');
...
function Add() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            //window.location.href = "/ProcessOrderApproval/ProcessOrderApprovalIndex";
            var msg = 'Data Saved Successfully...';
            var flg = 1;
            var mod = 0;
            var url = "/ProcessOrderApproval/ProcessOrderApprovalIndex";
            AlartMessage(msg, flg, mod, url);
            //}
            //if (result.Value == 0) {
...
function LoadMaingrid() {
    ...
    if (proctype == 'P') {
        ...
        var sup = $('#ddlMwrkdiv').val();
        if (sup == null) {
            proid = 0;
        } else {
            proid = $('#ddlMwrkdiv').val();
        }
    }
    ...
    localStorage.setItem('ProcessOrderApprovalFilter', menufilter);

    $.ajax({
        url: "/ProcessOrder/LoadApprovalMaingrid",
    ...
    if (RptTyp == "M") {
        ...
        $.ajax({
            ...
            url: "../ReportInline/Process/ProcessOrder/ProcessOrderYarnDyedReport.aspx?Masid=" + Repid + "&ProcessName=" + procname
                ...
                p[14] + "&Plandet=" + p[15] + "&Opdet=" + p[16] + "&Ewaybill=" + p[17] + "&Ewaydate=" + p[18] + "&Refno=" + p[19] + "&RptTyp=" +
                RptTyp + "&Companyid=" + compid,
            data: "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
