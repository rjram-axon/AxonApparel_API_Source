<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseOrderFinishReportInline.aspx.cs" Inherits="AxonApparels.ReportInline.Purchase.PurchaseOrderFinishInlineReport.PurchaseOrderFinishReportInline" %>
...
.break-before {
    ...
    position: relative;
        ...
        /*#ReportViewer1_ctl05_ctl00_First
        {
            display:none;
        }*/
...
<script>
    ...
    function printDiv() {
        debugger;
        //$('#VisibleReportContentReportViewer1_ctl09  table table table table table').css({});
        var printContents = document.getElementById('VisibleReportContentReportViewer1_ctl09').innerHTML;
        //var originalContents = document.body.innerHTML;

        //document.body.innerHTML = printContents;
        //window.document.write('<style> table table table table table  { width: 100%;  min-width: 100%; } table table table table table tbody tr td   {  max-width: 100%;  min-width: 100%; }</style>');
        //window.document.write('<style> table table table table {  width: 100%;  min-width: 100%; }  table table table  { width: 100%; min-width: 100%;  } table table   { width: 100%; min-width: 100%;   }</style>');
        //window.print();
        //document.body.innerHTML = originalContents;
        ////location.reload();


        window.document.write('<html><head><title>my div</title>');
