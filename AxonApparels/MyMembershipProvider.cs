...
namespace AxonApparels
{
    public class MyMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            UserName user = buslogin.GetDataUserDetails(username, password).Value;           
        ...
        public override MembershipUser GetUser(string username, bool userIsOnline)
        {
            ...
            {
                return new MembershipUser("MyMembershipProvider", username, UserManager.User.UserId, UserManager.User.Username, null, null, true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            }
            else
            {
                return null;
