<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsolidateOrderStatus.aspx.cs" Inherits="AxonApparels.Reports.Production.ConsolidateOrderStatus.ConsolidateOrderStatus" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="form1" runat="server">
                ...
                <div style="width: 1075px; margin-left:54px;" >
                    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
...
<head id="Head1" runat="server">
    ...
    <style>
        ...
        table table table table table
        {
           ...
           /*table table table table table tbody tr td:empty {
            visibility: hidden;
          }*/
