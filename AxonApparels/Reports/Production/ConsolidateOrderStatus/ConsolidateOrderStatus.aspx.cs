...
namespace AxonApparels.Reports.Production.ConsolidateOrderStatus
{
    public partial class ConsolidateOrderStatus : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/ConsolidateOrderStatus/ConsolidateOrderStatus.rdlc");

                ReportParameter rp1 = new ReportParameter("DtFilter", Request.QueryString["DtFilter"].ToString());

                ConsolidateOrderStausDataSet ds = GetData();
                CompanyDetStatementDataSet ds1 = GetData1();
                ReportDataSource datasource1 = new ReportDataSource("ConsolidateOrderStatusStatement", ds.Tables[1]);
        ...
        public ConsolidateOrderStausDataSet GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_GetConsolidateOrderStatus", con);
            ...
            sda.Fill(ds, "ConsolidateOrderStausDataSet");
