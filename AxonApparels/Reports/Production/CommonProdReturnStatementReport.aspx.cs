...
{
    public partial class CommonProdReturnStatementReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/CommonProdReturnStatementReport.rdlc");
            CommonProdReturnStatReport ds = GetData();

            ReportDataSource datasource = new ReportDataSource("CommonProdRecptStatReport", ds.Tables[1]);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
        }

        public CommonProdReturnStatReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_CommonProdReturnstmt", con);
           ...
           // cmd.Parameters.Add("@ToDate", SqlDbType.VarChar, 20).Value = Request.QueryString["ToDate"].ToString();
            ...
            sda.Fill(ds, "CommonProdReturnStatReport");
            return ds;
        }
    }
}