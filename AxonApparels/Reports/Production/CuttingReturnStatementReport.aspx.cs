...
{
    public partial class CuttingReturnStatementReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/CuttingReturnStatementReport.rdlc");
            CuttingReturnStatReport ds = GetData();

            ReportDataSource datasource = new ReportDataSource("CuttingReturnStatReport", ds.Tables[1]);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
        }

        public CuttingReturnStatReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_ProductionReturnstmt", con);
           ...
           // cmd.Parameters.Add("@WorkDivid", SqlDbType.Int).Value = Request.QueryString["ProcessorId"];
           ...
           // cmd.Parameters.Add("@ToDate", SqlDbType.VarChar, 20).Value = Request.QueryString["ToDate"].ToString();
            ...
            sda.Fill(ds, "CuttingReturnStatReport");
            return ds;
        }
    }
}