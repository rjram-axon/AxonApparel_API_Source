...
{
    public partial class CuttingReceiptStatementReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/CuttingReceiptStatementReport.rdlc");
            CuttingReceiptStatReport ds = GetData();

            ReportDataSource datasource = new ReportDataSource("CuttingReceiptStatReport", ds.Tables[1]);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
        }

        public CuttingReceiptStatReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_ProductionCutRecptstmt", con);
            ...
            sda.Fill(ds, "CuttingReceiptStatReport");
            return ds;
        }
    }
}