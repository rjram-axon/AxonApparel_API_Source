...
{
    public partial class CuttingOrderStatementReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/CuttingOrderStatementReport.rdlc");
                CuttingIssueStatReport ds = GetData();

                ReportDataSource datasource = new ReportDataSource("CuttingIssueStatReport", ds.Tables[1]);
        ...
        public CuttingIssueStatReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_ProductionCutIssuestmtforBulkorder", con);
            ...
            sda.Fill(ds, "CuttingIssueStatReport");
            return ds;
        }
    }
}