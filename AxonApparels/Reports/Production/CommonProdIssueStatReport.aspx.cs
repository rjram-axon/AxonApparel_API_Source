...
{
    public partial class CommonProdIssueStatReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/CommonProdIssueStatementReport.rdlc");
            CommonProdIssueStatementReport ds = GetData();

            ReportDataSource datasource = new ReportDataSource("CommonProdIssueStatementReport", ds.Tables[1]);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
        }

        public CommonProdIssueStatementReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_ProductionCommProdIssuestmtforBulkorder", con);
            ...
            CommonProdIssueStatementReport ds = new CommonProdIssueStatementReport();
            sda.Fill(ds, "CommonProdIssueStatementReport");
            return ds;
        }
    }
}