...
{
    public partial class SewingProdRecptStatementReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/SewingProdRecptStatementReport.rdlc");
            SewingProdRecptStatReport ds = GetData();

            ReportDataSource datasource = new ReportDataSource("SewingProdRecptStatementReport", ds.Tables[1]);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
        }

        public SewingProdRecptStatReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_ProdSewRecptStmtReport", con);
            ...
            sda.Fill(ds, "SewingProdRecptStatReport");
            return ds;
        }
    }
}