...
{
    public partial class OtherProcessReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/OtherProcessReport.rdlc");
                ...
                OtherProcessDataSet ds = GetData();
                ...
                ReportDataSource datasource1 = new ReportDataSource("OtherProcessDataSet", ds.Tables[1]);
        ...
        public OtherProcessDataSet GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_OtherProcessReport", con);
            ...
            sda.Fill(ds, "OtherProcessDataset");

            //OtherProcesReportStatement ds = new OtherProcesReportStatement();
            //sda.Fill(ds, "OtherProcesReportDataset");
