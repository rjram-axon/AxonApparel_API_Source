<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsolidateProductionCostingReport.aspx.cs" Inherits="AxonApparels.Reports.Production.ConsolidateProductionCosting.ConsolidateProductionCostingReport" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(' table table table table table tbody  tr td').css('height', 'auto');
            //$('td').removeAttr('style');
    ...
    <style>
        ...
        table table table table table
        {
            ...
            table table table table table tbody tr td table
            {
                max-width: 100%;
                min-width: 100%;
               height:auto;
