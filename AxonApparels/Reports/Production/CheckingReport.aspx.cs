...
{
    public partial class CheckingReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/CheckingReport.rdlc");
                ...
                CheckingDataSet ds = GetData();
                CheckingReportChartDataSet ds1 = GetData1();
                ...
                ReportDataSource datasource1 = new ReportDataSource("CheckingDataSet", ds.Tables[1]);
                ReportDataSource datasource2 = new ReportDataSource("CheckingReportChartDataSet", ds1.Tables[1]);
        ...
        public CheckingDataSet GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_CheckingReport", con);
        ...
        public CheckingReportChartDataSet GetData1()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_CheckingReportChart", con);
            SqlDataAdapter sda = new SqlDataAdapter();
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            sda.Fill(ds, "CheckingReportChartDataSet");
