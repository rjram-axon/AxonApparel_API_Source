...
{
    public partial class SewingReturnStatementReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/SewingReturnStatReport.rdlc");
            SewingReturnStatReport ds = GetData();

            ReportDataSource datasource = new ReportDataSource("SewingReturnStatReport", ds.Tables[1]);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
        }

        public SewingReturnStatReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_SewingReturnstmt", con);
           ...
           // cmd.Parameters.Add("@ToDate", SqlDbType.VarChar, 20).Value = Request.QueryString["ToDate"].ToString();
            ...
            SewingReturnStatReport ds = new SewingReturnStatReport();
            sda.Fill(ds, "SewingReturnStatReport");
            return ds;
        }
    }
}