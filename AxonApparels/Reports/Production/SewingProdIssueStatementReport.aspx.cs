...
{
    public partial class SewingProdIssueStatementReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Production/SewingProdIssueStatementReport.rdlc");
            SewingProdIssueStatReport ds = GetData();

            ReportDataSource datasource = new ReportDataSource("SewingProdIssueStatementReport", ds.Tables[1]);

            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
        }

        public SewingProdIssueStatReport GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_ProdSewIssueStmtReport", con);
            ...
            sda.Fill(ds, "SewingProdIssueStatReport");
            return ds;
        }
    }
}