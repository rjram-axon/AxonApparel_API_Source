<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderStatusReport.aspx.cs" Inherits="AxonApparels.Reports.OrderStatusReport" %>
                ...
                <div class=" " style="display: inline-block; font-family: Verdana; font-size: 8pt; vertical-align: top;">
                    <table cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td height="28px">
                                    <div id="ReportViewer1_ctl05_ctl04_ctl00" style="font-family: Verdana; font-size: 8pt; border: 1px solid transparent; background-color: transparent; cursor: default;">
                                        <table id="ReportViewer1_ctl05_ctl04_ctl00_Button" title="Export drop down menu">
                                            <tbody>
                                                <tr>
                                                    <td><a id="ReportViewer1_ctl05_ctl04_ctl00_ButtonLink" title="Export drop down menu" alt="Export drop down menu" href="javascript:void(0)" style="text-decoration: none; cursor: pointer;">
                                                        <img id="ReportViewer1_ctl05_ctl04_ctl00_ButtonImg" src="/Reserved.ReportViewerWebControl.axd?OpType=Resource&amp;Version=11.0.2802.16&amp;Name=Microsoft.Reporting.WebForms.Icons.Export.gif" alt="Export drop down menu" style="border-style: None; height: 16px; width: 16px;"><span style="width: 5px; text-decoration: none;"> </span>
                                                        <img id="ReportViewer1_ctl05_ctl04_ctl00_ButtonImgDown" src="/Reserved.ReportViewerWebControl.axd?OpType=Resource&amp;Version=11.0.2802.16&amp;Name=Microsoft.Reporting.WebForms.Icons.ArrowDown.gif" alt="Export drop down menu" style="border-style: None; height: 6px; width: 7px; margin-bottom: 5px;"></a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div id="ReportViewer1_ctl05_ctl04_ctl00_Menu" style="background-color: White; border: 1px #336699 Solid; display: none; position: absolute; padding: 1px; z-index: 1;">
                                        ...
                                        <div style="position: absolute; z-index: -1; top: 0px; left: 0px; width: 26px; opacity: 0.05; background-color: black;"></div>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
