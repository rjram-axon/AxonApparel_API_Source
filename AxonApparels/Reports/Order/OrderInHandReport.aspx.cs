...
{
    public partial class OrderInHandReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Order/OrderInHandReport.rdlc");
                ...
                OrderInHandReportDataSet ds = GetData();
                ...
                ReportDataSource datasource1 = new ReportDataSource("OrderInHandReportStatement", ds.Tables[1]);
        ...
        public OrderInHandReportDataSet GetData()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_OrderInHandReport", con);
            ...
            sda.Fill(ds, "OrderInHandReportDataset");
