...
{
    public partial class SpecialRequisitionReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Stores/SpecialRequisitionReport.rdlc");
                ...
                SpecialRequisitionDataSet ds1 = GetData1();
                ...
                ReportDataSource datasource2 = new ReportDataSource("SpecialRequisitionStatement", ds1.Tables[1]);
        ...
        public SpecialRequisitionDataSet GetData1()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_SpecialRequisitionReport", con);
            SqlDataAdapter sda = new SqlDataAdapter();
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            sda.Fill(ds, "SpecialRequisitionDataSet");
