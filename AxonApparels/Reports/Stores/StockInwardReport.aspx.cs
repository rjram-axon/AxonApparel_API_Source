...
{
    public partial class StockInwardReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Stores/StockInwardReport.rdlc");
            ...
            StockInwardReportDataSet ds = GetData1();
            CompanyDetStatementDataSet ds1 = GetData();
            ...
            ReportDataSource datasource1 = new ReportDataSource("StockInwardReportStatement", ds.Tables[1]);
            ReportDataSource datasource2 = new ReportDataSource("StockInwardCompanyDetStatement", ds1.Tables[1]);
        ...
        public StockInwardReportDataSet GetData1()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_StockInwardReport", con);
            SqlDataAdapter sda = new SqlDataAdapter();
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            StockInwardReportDataSet ds = new StockInwardReportDataSet();
            sda.Fill(ds, "StockInwardReportDataSet");
