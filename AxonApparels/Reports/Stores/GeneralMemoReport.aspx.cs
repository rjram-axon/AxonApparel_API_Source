...
{
    public partial class GeneralMemoReport : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/Stores/GeneralMemoReport.rdlc");
            ...
            GeneralMemoReportDataSet ds1 = GetData1();
            ...
            ReportDataSource datasource1 = new ReportDataSource("GeneralMemoCompanyDetStatement", ds.Tables[1]);
            ReportDataSource datasource2 = new ReportDataSource("GeneralMemoReportStatement", ds1.Tables[1]);
        ...
        public GeneralMemoReportDataSet GetData1()
        {
            string conString = ConfigurationManager.ConnectionStrings["AxonApparelConnectionString"].ConnectionString;
            con = new SqlConnection(conString);
            SqlCommand cmd = new SqlCommand("Proc_Apparel_GeneralMemoReport", con);
            SqlDataAdapter sda = new SqlDataAdapter();
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            if (Request.QueryString["IsReturn"] != "")
            {
                cmd.Parameters.Add("@IsReturn", SqlDbType.VarChar, 50).Value = Request.QueryString["IsReturn"].ToString();
            }
            ...
            sda.Fill(ds, "GeneralMemoReportDataSet");
