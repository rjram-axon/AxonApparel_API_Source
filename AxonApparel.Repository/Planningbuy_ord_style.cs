...
namespace AxonApparel.Repository
{
    ...
    public partial class Planningbuy_ord_style
    {
        public Planningbuy_ord_style()
        {
            this.Job_Ord_Mas = new HashSet<PlanningJob_Ord_Mas>();
            this.ComboColor = new HashSet<PlanningComboColor>();
            this.Combosize = new HashSet<PlanningCombosize>();
        }
        ...
        public virtual ICollection<PlanningJob_Ord_Mas> Job_Ord_Mas { get; set; }
        public virtual ICollection<PlanningComboColor> ComboColor { get; set; }
        public virtual ICollection<PlanningCombosize> Combosize { get; set; }
    }
}
