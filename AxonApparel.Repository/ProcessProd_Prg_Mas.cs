...
namespace AxonApparel.Repository
{
    ...
    public partial class ProcessProd_Prg_Mas
    {
        public ProcessProd_Prg_Mas()
        {
            this.Prod_Prg_Det = new HashSet<ProcessProd_Prg_Det>();
        }
        ...
        public virtual ICollection<ProcessProd_Prg_Det> Prod_Prg_Det { get; set; }
