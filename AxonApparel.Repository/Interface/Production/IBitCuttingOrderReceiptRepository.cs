...
{
    public interface IBitCuttingOrderReceiptRepository
    {
        IQueryable<CuttingReceipt> GetCuttingReceiptInf();
        IQueryable<CuttingReceipt> GetCuttingRecptDetails(int CompanyId, int CompanyUnitId, string OrdType, string refno, int styleid, string ordo, int buyerid, string jobordno, string inorext,int Processid);
