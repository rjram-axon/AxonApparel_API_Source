...
{
    public interface IBitCuttingOrderReturnRepository
    {
        IQueryable<CuttingReturn> GetCuttingReturnDetails(int CompanyId, int CompanyUnitId, string OrdType, string refno, int styleid, string OrderNo, int buyerid, string jobordno, string inorext, int Processid);
        ...
        IList<CuttingReturn> GetMainData(int ID, string OrderType, string InterExternal, string FromDate, string ToDate, string jobordno, string orderno, string RefNo,int Supplierid,int employeeid,int Processid);
