...
{
    public class BitCuttingOrderReturnBusiness : IBitCuttingOrderReturnBusiness
    {
        IBitCuttingOrderReturnRepository CuttingRetDet = new BitCuttingOrderReturnRepository();

        public Response<IQueryable<CuttingReturn>> GetCuttingReturnDetails(int CompanyId, int CompanyUnitId, string OrdType, string refno, int styleid, string OrderNo, int buyerid, string jobordno, string inorext,int Processid)
        {
            try
            {
                var CuttingOrderReturnDT = CuttingRetDet.GetCuttingReturnDetails(CompanyId, CompanyUnitId, OrdType, refno, styleid, OrderNo, buyerid, jobordno, inorext,Processid);
        ...
        public Response<IList<Domain.CuttingReturn>> GetMaindt(int Id, string OrderType, string InterExternal, string Fromdate, string Todate, string jobordno, string orderno, string refno, int Supplierid,int employeeid,int Processid)
        {
            try
            {
                var getmaindt = CuttingRetDet.GetMainData(Id, OrderType, InterExternal, Fromdate, Todate, jobordno, orderno, refno, Supplierid, employeeid, Processid);
