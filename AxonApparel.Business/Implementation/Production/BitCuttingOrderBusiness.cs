...
{
    public class BitCuttingOrderBusiness : IBitCuttingOrderBusiness
    {
        IBitCuttingOrderRepository CuttingDet = new BitCuttingOrderRepository();
        ...
        public Response<IQueryable<CuttingOrder>> GetCuttingOrderDetails(int CompanyId, int CompanyUnitId, string OrderType, string refno, int styleid, string ordo,int Buyerid,int Processid)
        {
            try
            {
                var CuttingOrderDt = CuttingDet.GetTrimsDetails(CompanyId, CompanyUnitId, OrderType, refno, styleid, ordo, Buyerid, Processid);
        ...
        public Response<IList<Domain.CuttingOrder>> GetMaindt(int compid, int unitid, int buyerid, int masid, int empid, string refno, string orderno, string supptype, string ordtype, string cuttingordno, string jobordno, string FromDate, string ToDate,int supplierid,int Processid)
        {
            try
            {
                var getmaindt = CuttingDet.GetMainData(compid, unitid, buyerid, masid, empid, refno, orderno, supptype, ordtype, cuttingordno, jobordno, FromDate, ToDate, supplierid, Processid);
