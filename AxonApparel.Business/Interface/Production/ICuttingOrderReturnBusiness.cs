...
{
    public interface ICuttingOrderReturnBusiness
    {
        Response<IQueryable<CuttingReturn>> GetCuttingReturnDetails(int CompanyId, int CompanyUnitId, string OrdType, string refno, int styleid, string OrderNo, int buyerid, string jobordno, string inorext);
        ...
        Response<IList<Domain.CuttingReturn>> GetMaindt(int Id, string OrderType, string InterExternal, string Fromdate, string Todate, string jobordno, string orderno, string refno, int Supplierid, int employeeid);
